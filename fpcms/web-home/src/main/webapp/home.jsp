...
<duowan:override name="pageRight">
	...
	<div >
		<div class="neirong">
			&nbsp; &nbsp;${default.company}于2005年挂牌树立,是经政府同意的首家具有${default.city}开发票，<span>${default.city}</span>代开发票资历的专业税务开公司。我司具有一支高素质、经验丰富、训练有素的高效率办税专业财税咨询团队。通过多年来的展开，与工商、税务、财政、海关、银行等部分及各地多家公司树立了紧密的合作关系，在全国各地开设了分公司。公司首要供给<span>${default.city}</span>开发票，发票征询，开记账，彻底触及全国事务。<br />
...
<div>
	<div id="hiddenNews" >新闻</div>
	<div>
		<div style="position: absolute; background:#F00; display: block; " id="hiddenDiv" ></div>
