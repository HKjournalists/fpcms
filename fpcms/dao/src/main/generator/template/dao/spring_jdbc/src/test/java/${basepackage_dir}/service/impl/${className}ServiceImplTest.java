...
import com.fpcms.shared.${className}DataFactory;
import com.fpcms.shared.dao.${className}Dao;
import com.fpcms.shared.model.${className};
import com.fpcms.shared.model.${className};
import com.fpcms.shared.service.impl.${className}ServiceImpl;
