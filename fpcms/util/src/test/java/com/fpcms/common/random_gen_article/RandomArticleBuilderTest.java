...
public class RandomArticleBuilderTest extends Assert{
	...
	@Test
	public void test_buildRandomArticle() {
		RandomArticleBuilder builder = new RandomArticleBuilder();
		...
		assertNotNull(a.getPerfectKeyword());
		System.out.println(a.getPerfectKeyword()+" -------- size:"+a.getContent().length()+" " +a.getContent());
	}
	
	@Test
	public void test_buildBySearchKeyword() {
		RandomArticleBuilder builder = new RandomArticleBuilder();
		RandomArticle a = builder.buildBySearchKeyword("中文", "函馆", "函馆 2009年10月");
		assertTrue("a.getContent().length() > 400 is false,length"+a.getContent().length()+" content:"+a.getContent(),a.getContent().length() > 400);
		assertNotNull(a.getPerfectKeyword());
		System.out.println(a.getPerfectKeyword()+" -------- size:"+a.getContent().length()+" " +a.getContent());
	...
	@Test
	public void test_buildBySearchKeyword2() {
		RandomArticleBuilder builder = new RandomArticleBuilder();
		RandomArticle a = builder.buildBySearchKeyword("中文", "攻袭", "攻袭 2007年");
		assertTrue("a.getContent().length() > 400 is false,length"+a.getContent().length()+" content:"+a.getContent(),a.getContent().length() > 400);
		assertNotNull(a.getPerfectKeyword());
		System.out.println(a.getPerfectKeyword()+" -------- size:"+a.getContent().length()+" " +a.getContent());
	...
	public void test_chinese_segment() {
		...
		RandomArticle a = builder.buildBySearchKeyword("唐山开发票", finalSearchKeyword,finalSearchKeyword);
		assertTrue("a.getContent().length() > 400 is false,length"+a.getContent().length()+" content:"+a.getContent(),a.getContent().length() > 400);
