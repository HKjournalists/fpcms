...
public class SimpleHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
	 ...
	 */
	public InputStream executeRequest(String url,String parameters)
		...
		ByteArrayInputStream bytes = new ByteArrayInputStream(IOUtils.toByteArray(responseBody));
	...
	protected void prepareConnection(HttpURLConnection con, int contentLength) throws IOException {
		...
		con.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 5.1; rv:17.0) Gecko/20100101 Firefox/17.0");
		con.setRequestProperty(HTTP_HEADER_ACCEPT_LANGUAGE, StringUtils.toLanguageTag(LocaleContextHolder.getLocale()));
